...
*/
var lifeAtTheFarm : [String] = ["Wake up","Wash The Dishes","Milk The Cows"]

lifeAtTheFarm.append("Call the Cows")
var currentTask: Int = 0

print(lifeAtTheFarm[0])
print(lifeAtTheFarm[currentTask])
currentTask+=1
print(lifeAtTheFarm[currentTask])
lifeAtTheFarm.insert("Run a milee", atIndex: 3)
print(lifeAtTheFarm[currentTask])
